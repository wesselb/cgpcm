...
\usepackage{icml2017}  % option: accepted
...
\begin{figure*}[t]
    ...
    \begin{tabularx}{\linewidth}{
        ...
        $f\cond h$ & $h$ & $k_{f\cond h}$ & PSD of $k_{f\cond h}$
    \end{tabularx}
    \includegraphics[width=\linewidth, height=3cm]{resources/learning_known_kernels_causal_sample_gpcm_cropped.pdf}
    CGPCM
    \includegraphics[width=\linewidth, height=3cm]{resources/learning_known_kernels_causal_sample_cgpcm_cropped.pdf}
    \caption{Toy. Here {\color{red}red} denotes truth; {\color{darkgreen}green} denotes observations, the emperical autocorrelation, and the periodogram for respectively the function $f\cond h$, the kernel $k_{f\cond h}$, and PSD of $k_{f\cond h}$; {\color{blue}blue} denotes quantities learned through the MF approximation; and {\color{mycyan}cyan} denotes quantities learned through the SMF approximation.}
...
\begin{figure*}[t]
    ...
    \begin{tabularx}{\linewidth}{
        ...
        $f\cond h$ & $h$ & $k_{f\cond h}$ & PSD of $k_{f\cond h}$
    \end{tabularx}
    \includegraphics[width=\linewidth, height=3cm]{resources/learning_known_kernels_acausal_sample_gpcm_cropped.pdf}
    CGPCM
    \includegraphics[width=\linewidth, height=3cm]{resources/learning_known_kernels_acausal_sample_cgpcm_cropped.pdf}
    \caption{Toy. Here {\color{red}red} denotes truth; {\color{darkgreen}green} denotes observations, the emperical autocorrelation, and the periodogram for respectively the function $f\cond h$, kernel $k_{f\cond h}$, and power spectral density $\log \mathcal{F}\{k_{f\cond h}\}$; {\color{blue}blue} denotes quantities learned through the MF approximation; and {\color{mycyan}cyan} denotes quantities learned through the SMF approximation.}
    \label{fig:toy_scausal_sample}
\end{figure*}


\subsection{Head-Related Transfer Function}
The head-related transfer function (HRTF) describes how the reception of sound by the ear depends on the position from which the sound originates.
