...
In \cref{subsec:roughness} we showed that the CGPCM models both smooth and rough isgnals, whereas the GPCM only models smooth signals. We perform two experiments that show the significance of this modelling capability.
