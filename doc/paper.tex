...
\subsection{Head-Related Impulse Response}
The head-related impulse response (HRIR) describes how the reception of sound by the ear depends on the position from which the sound originates.
\begin{figure*}[t]
    \centering
